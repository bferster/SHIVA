...
$(con).css("background-color","#"+options.backCol);$(con).width(options.width);$(con).height(options.height);$(con).html("");var colors=d3.scale.category10();if(options.chartType=="Network"){if(options.dataSourceUrl)
