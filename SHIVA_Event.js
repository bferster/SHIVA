...
SHIVA_Event.prototype.SetEventHelp=function()
{
	...
	helpText['shapes']="The 'Shape' tab allows for configuring the dimensions of your event as well as some of the basic behavior of that event on the page. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	...
	helpText['colors']="The 'Colors' tab allows for configuring text color, border color, background color, and the opacity of the event dialog box. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	...
	helpText['actions']="The 'Action' tab allows for configuring how your event dialog box responds to various kinds of user For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	helpText['click']="Click on the text box to the right and enter a value that determines what action to trigger when a user clicks on your event dialog box. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	helpText['hover']="Click on the text box to the right and enter a value that determines what action to trigger when a user hovers over your event dialog box. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	helpText['done']="Click on the text box to the right and enter a value that determines what action to trigger when a user finishes interacting with your event dialog box. Note this only applies to events like 'ask' and 'menu' that actually require user interaction. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	helpText['response']="Click on the text box to the right and enter a value that determines how to store user input when a user finishes interacting with your event dialog box. Note this only applies to events like 'ask' and 'menu' that actually require user interaction. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	...
	helpText['times']="The 'Time' tab allows for configuring various aspects of the timing for your video event. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	...
	helpText['content']="The 'Content' tab allows for configuring what text, images, and other content to display in your video event. For a detailed guide on using Video Events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
	helpText['type']="Use the drop-down menu to the right to choose what type of event you would like to use. For a detailed description of video events please visit <a href='https://wiki.shanti.virginia.edu/display/KB/SHIVA+Videos+Tool#SHIVAVideosTool-AddingVideoAnnotations'>this link</a>."
