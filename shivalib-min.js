...
shivaLib.SendShivaMessage("ShivaImage=move|"+window.name+"|"+shivaLib.options.pos);}});var v=options.pos.split("|");this.PositionPoster(v[0],v[1],v[2]);if(options.dataSourceUrl){str="<img src='"+options.dataSourceUrl+"' ";str+="height='100%' width='100%'>";$("#posterDiv").append(str);}
...
shivaLib.SendShivaMessage("ShivaImage=move|"+window.name+"|"+shivaLib.options.pos);}});var x=$("#posterDiv").css("left").replace(/px/,"");x=-x/w/4*w/this.posterScale;var y=$("#posterDiv").css("top").replace(/px/,"");y=-y/h/4*h/this.posterScale;$("#posterOverBox").css({"left":x+"px","top":y+"px"});}
