...
shivaLib.SendShivaMessage("ShivaImage=move|"+shivaLib.options.pos);}});var v=options.pos.split("|");this.PositionPoster(v[0],v[1],v[2]);if(options.dataSourceUrl){str="<img src='"+options.dataSourceUrl+"' ";str+="height='100%' width='100%'>";$("#posterDiv").append(str);}
if(this.posterMode!="Connect"){this.DrawPosterPanes(-1,"draw");this.DrawLayerControlBox(this.items,(options.controlbox=="true"));}
this.DrawPosterOverview();this.DrawPosterPanes(-1,"drag");this.SendReadyMessage(true);}
...
shivaLib.SendShivaMessage("ShivaImage=move|"+shivaLib.options.pos);}});var x=$("#posterDiv").css("left").replace(/px/,"");x=-x/w/4*w/this.posterScale;var y=$("#posterDiv").css("top").replace(/px/,"");y=-y/h/4*h/this.posterScale;$("#posterOverBox").css({"left":x+"px","top":y+"px"});}
...
str+=this.items[i].style.replace(/\|/g,";");str+="'>"
