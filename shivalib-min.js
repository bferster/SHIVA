...
DrawPosterGrid();this.DrawPosterOverview();this.DrawPosterPanes(-1,"drag");this.SendReadyMessage(true);}
...
v=this.options.pos.split("|");this.PositionPoster(v[0],v[1],v[2]);$("#shcr"+num).attr("checked","checked");}
